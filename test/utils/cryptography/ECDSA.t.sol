...
contract ECDSATest is Test {
    ...
    function test_RecoverWithValidEMin() public view {
        uint256 memPtr = Memory.allocate(128);
        uint256 e = 0;
        assertNotEq(ECDSA.recover(memPtr, e, 27, 1, 1), 0);
    }
    ...
    function test_RecoverWithValidV27() public view {
        uint256 memPtr = Memory.allocate(128);
        uint256 v = 27;
        assertNotEq(ECDSA.recover(memPtr, 0, v, 1, 1), 0);
    }
    ...
    function test_RecoverWithInvalidV() public view {
        uint256 memPtr = Memory.allocate(128);
        uint256 v = 42;
        assertEq(ECDSA.recover(memPtr, 0, v, 1, 1), 0);
    }

    function test_RecoverWithValidRMin() public view {
        uint256 memPtr = Memory.allocate(128);
        uint256 r = 1;
        assertNotEq(ECDSA.recover(memPtr, 0, 27, r, 1), 0);
    }
    ...
    function test_RecoverWithInvalidR0() public view {
        uint256 memPtr = Memory.allocate(128);
        uint256 r = 0;
        assertEq(ECDSA.recover(memPtr, 0, 27, r, 1), 0);
    }
    ...
    function test_RecoverWithValidSMin() public view {
        uint256 memPtr = Memory.allocate(128);
        uint256 s = 1;
        assertNotEq(ECDSA.recover(memPtr, 0, 27, 1, s), 0);
    }
    ...
    function test_RecoverWithInvalidS0() public view {
        uint256 memPtr = Memory.allocate(128);
        uint256 s = 0;
        assertEq(ECDSA.recover(memPtr, 0, 27, 1, s), 0);
    }
