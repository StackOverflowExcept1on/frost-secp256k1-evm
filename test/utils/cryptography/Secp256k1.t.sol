...
contract Secp256k1Test is Test {
    ...
    function test_YParity() public pure {
        vm.assertEq(Secp256k1.yParity(0x98F66641CB0AE1776B463EBDEE3D77FE2658F021DB48E2C8AC7AB4C92F83621E), 0);
        vm.assertEq(Secp256k1.yParity(0x0E994B14EA72F8C3EB95C71EF692575E775058332D7E52D0995CF8038871B67D), 1);
    }

    function test_YParityEthereum() public pure {
        vm.assertEq(Secp256k1.yParityEthereum(0x98F66641CB0AE1776B463EBDEE3D77FE2658F021DB48E2C8AC7AB4C92F83621E), 27);
        vm.assertEq(Secp256k1.yParityEthereum(0x0E994B14EA72F8C3EB95C71EF692575E775058332D7E52D0995CF8038871B67D), 28);
    }

    function test_YCompressed() public pure {
        vm.assertEq(Secp256k1.yCompressed(0x98F66641CB0AE1776B463EBDEE3D77FE2658F021DB48E2C8AC7AB4C92F83621E), 2);
        vm.assertEq(Secp256k1.yCompressed(0x0E994B14EA72F8C3EB95C71EF692575E775058332D7E52D0995CF8038871B67D), 3);
    }
